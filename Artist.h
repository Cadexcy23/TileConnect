...
public:
	...
	void drawImage(SDL_Texture* tex, int x, int y, int w = 0, int h = 0, SDL_Rect* source = NULL, double r = 0, SDL_Point* center = NULL, SDL_RendererFlip flip = SDL_FLIP_NONE, bool scaled = true);
